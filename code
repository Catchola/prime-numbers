...
<body>
    <div id="home">
        <img id="logo-preto" src="_img/logo-preto.png">
    </div>

    <ul id="listaPrimos"></ul>

    <button onclick='location.href=http://www.groweer.com' id="btnHome">Home</button>
    <button onclick='btnTestaPrimo()' id="btnTestaPrimo">Testar número primo</button>
    <button onclick='btnImprimePrimosAte()' id="btnImprimePrimosAte">Mostrar primos até...</button>
    <button onclick='btnImprimeXPrimos()' id="btnImprimeXPrimos">Mostrar X primos</button>
